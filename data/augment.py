...
class Compose:
    ...
    Examples:
        ...
        >>> compose.append(SourceCrop((224, 224)))
    ...
    def tolist(self):
        ...
        Examples:
            >>> transforms = [RandomFlip(), RandomPerspective(10), SourceCrop()]
            >>> compose = Compose(transforms)
...
class Mosaic(BaseMixTransform):
    ...
    def _mosaic3(self, labels: dict[str, Any]) -> dict[str, Any]:
        ...
        This method arranges three images in a horizontal layout, with the main image in the source and two additional
    ...
    def _mosaic9(self, labels: dict[str, Any]) -> dict[str, Any]:
        ...
        This method combines nine images into a single mosaic image. The input image is placed at the source, and eight
...
def classify_transforms(
    ...
    tfl += [T.SourceCrop(size), T.ToTensor(), T.Normalize(mean=torch.tensor(mean), std=torch.tensor(std))]
...
class SourceCrop:
    ...
    ratio. It is designed to be part of a transformation pipeline, e.g., T.Compose([SourceCrop(size), ToTensor()]).
    ...
    Methods:
        __call__: Apply the source crop transformation to an input image.

    Examples:
        >>> transform = SourceCrop(640)
    ...
    def __init__(self, size: int | tuple[int, int] = (640, 640)):
        """Initialize the SourceCrop object for image preprocessing.

        This class is designed to be part of a transformation pipeline, e.g., T.Compose([SourceCrop(size), ToTensor()]).
    ...
    def __call__(self, im: Image.Image | np.ndarray) -> np.ndarray:
        ...
        This method resizes and crops the source of the image using a letterbox method. It maintains the aspect ratio of
