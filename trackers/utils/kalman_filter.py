...
class KalmanFilterXYAH:
    ...
    def update(self, mean: np.ndarray, covariance: np.ndarray, measurement: np.ndarray):
        ...
        Args:
            ...
            covariance (np.ndarray): The state's covariance matrix (8x8 dimensional).
            measurement (np.ndarray): The 4 dimensional measurement vector (x, y, a, h), where (x, y) is the source
...
class KalmanFilterXYWH(KalmanFilterXYAH):
    ...
    is the source position, w is the width, h is the height, and vx, vy, vw, vh are their respective velocities. The
    ...
    def update(self, mean: np.ndarray, covariance: np.ndarray, measurement: np.ndarray):
        ...
        Args:
            mean (np.ndarray): The predicted state's mean vector (8 dimensional).
            covariance (np.ndarray): The state's covariance matrix (8x8 dimensional).
            measurement (np.ndarray): The 4 dimensional measurement vector (x, y, w, h), where (x, y) is the source
